/*
  Catch Errors HandlerWith async/await
  you need some way to catch errors
...
/*
  ...
  In development we show good error messages so
  if we hit a syntax error or any other previously un-handled error,
